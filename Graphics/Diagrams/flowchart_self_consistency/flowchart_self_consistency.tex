...
\begin{tikzpicture}	
    ...
    \node (t1) at ($(start.center)+(0,-0.2)$) {\begin{tabular}{c}Retrieve $\varepsilon_{\mathfrak{12}}^{\textbf{k}}$ and $\mathcal{U}^{\textbf{q}}_{\mathfrak{1234}}$ \\ from DFT and cRPA, respectively\end{tabular}};
