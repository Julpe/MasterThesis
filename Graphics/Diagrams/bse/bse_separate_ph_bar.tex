...
\begin{feynman}
	...
	\diagram* {
		...
		(b2) -- [fermion, gray, edge label'=$\kp;\mathfrak{2}$] (a2),
		(d2) -- [fermion, gray, edge label'=$\kp-\q;\mathfrak{3}$] (c2),
		(c1) -- [fermion, gray, edge label'=$\k-\q;\mathfrak{4}$] (d1),
	};
\end{feynman}
\end{tikzpicture}
\begin{tikzpicture}[baseline=(current bounding box.center)]
...
\begin{feynman}
	...
	\diagram* {
		(a1) -- [gray, fermion, edge label'=$\k;\mathfrak{1}$] (b1),
		(c1) -- [gray, fermion, edge label'=$\k-\q;\mathfrak{4}$] (d1),
		(b1) -- (c1) -- (c2) -- (b2) -- (b1),
		(b3) -- (c3) -- (c4) -- (b4) -- (b3),
		(b2) -- [fermion] (b3),
		(c3) -- [fermion] (c2),
		(d4) -- [gray, fermion, edge label'=$\kp-q;\mathfrak{3}$] (c4),
		(b4) -- [gray, fermion, edge label'=$\kp;\mathfrak{2}$] (a4),
	};
\end{feynman}
\end{tikzpicture}
