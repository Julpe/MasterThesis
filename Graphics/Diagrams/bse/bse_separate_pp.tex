...
\begin{feynman}
	...
	\diagram* {
		...
		(b2) -- [fermion, gray, edge label'=$\q-\kp;\mathfrak{2}$] (a2),
		(d2) -- [fermion, gray, edge label'=$\q-\k;\mathfrak{3}$] (c2),
		(c1) -- [fermion, gray, edge label'=$\kp;\mathfrak{4}$] (d1),
	};
\end{feynman}
\end{tikzpicture}
\begin{tikzpicture}[baseline=(current bounding box.center)]
...
\begin{feynman}
	...
	\diagram* {
		(b1) -- (c1) -- (c2) -- (b2) -- (b1),
		(a1) -- [fermion, gray, edge label'=$\k;\mathfrak{1}$] (b1),
		(a2) -- [fermion, gray, edge label=$\q-\k;\mathfrak{3}$] (b2),
		(c2) -- [fermion] (d2),
		(c1) -- [fermion] (d1),
		(d1) -- (e1) -- (e2) -- (d2) -- (d1),
		(e2) -- [fermion, gray, edge label=$\q-\kp;\mathfrak{2}$] (f2),
