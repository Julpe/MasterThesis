...
\begin{figure}[ht!]
	...
	\end{subfigure}
	\caption{Frequency dependence of the real and imaginary part of the self-energy for the single-band and the fictitious two-band dataset. \subref{subfig:sigma_difference_oneband_twoband_lower_stat_frequency} shows the comparison for a lower QMC statistics run, whereas \subref{subfig:sigma_difference_oneband_twoband_higher_stat_frequency} for a four-times higher one. The improved behaviour for large frequencies is not surprising, as the increase of QMC measurements mitigates some stochastic noise.}
