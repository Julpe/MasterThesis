...
\begin{align}
\begin{split}
	\bm F_{\dens}^{\q}&=\left [\bm F_{\dens}^{\omega}+2\bm V^{\vv{q}}\left (1+\bm\chi_{0}^{\omega}\bm F_{\dens}^{\omega}\right )\right ]\left [\bm\unity-\bm\chi_{0}^{\nl;\q}\bm F_{\dens}^{\omega}-2\bm\chi_{0}^{\q}\bm V^{\vv{q}}\left (1+\bm\chi_{0}^{\omega}\bm F_{\dens}^{\omega}\right )\right ]^{-1}
...
\begin{align}
	\Sigma^{\k}_{\mathfrak{12}}&=\Sigma_{\text{H};\mathfrak{12}}^{\vv{k}}-\frac{1}{\beta}\sum_{\substack{\q\nu';\mathfrak{abcd}\\\mathfrak{efgh}}}\Bigg [\!\bigg (\mathcal{U}^{\vv{q}}_{\mathfrak{a1bc}} -\frac12 \tilde{\mathcal{U}}_{\mathfrak{a1bc}} \bigg )\,\gamma_{\dens;\mathfrak{cbed}}^{\q\nu'}\!\left (\unity_{\mathfrak{de2h}}^{\nu'\nu}-\mathcal{U}^{\vv{q}}_{\dens;\mathfrak{defg}}\chi^{\q}_{\dens;\mathfrak{gf2h}}\right )\nonumber\\
...
\begin{split}
	&=\Sigma_{\text{H};\mathfrak{12}}^{\vv{k}}-\frac{1}{\beta}\sum_{\substack{\q\nu';\mathfrak{abcd}\\\mathfrak{efgh}}}\Bigg [\!\bigg (U_{\mathfrak{a1bc}} + V^{\vv{q}}_{\mathfrak{a1bc}} -\frac12 U_{\mathfrak{acb1}} \bigg )\,\gamma_{\dens;\mathfrak{cbed}}^{\q\nu'}\times\\
