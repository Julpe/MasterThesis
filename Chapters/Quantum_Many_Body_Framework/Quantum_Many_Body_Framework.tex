...
\end{align}
This is especially useful, since the generalized physical susceptibility enters the SDE (\ref{eq:sde_vrg}) with the three-leg vertices of \eqref{eq:vrg}. Hence, this scheme proves to be powerful \cite{Worm2023a, Kitatani2022} for this explicit form of the equation of motion of $\Sigma_{\mathfrak{12}}^{\k}$. Lastly, it can be shown \cite{Katanin2009}, that for the three-leg vertex $\gamma_{\dens/\magn;\mathfrak{1234}}^{\q\k}\overset{\nu\to\infty}{\longrightarrow}\unity_{\mathfrak{1234}}$ holds.
