...
\begin{align}
	F^{\q\k\kp}_{\mathfrak{1234};\ss'}=\beta^2\left [\left (\chi_{0;\mathfrak{1234}}^{\q\k\k}\right )^{-1}-\sum_{\k\kp;\mathfrak{abcd}}\left (\chi_{0;\mathfrak{12ba}}^{\q\k\k}\right )^{-1} \chi_{\mathfrak{abcd};\ss'}^{\q\k\kp} \left (\chi_{0;\mathfrak{dc34}}^{\q\kp\kp}\right )^{-1}\right ]^{-1}.
\end{align}
...
\begin{align}\label{eq:sde_vrg}
	\Sigma_{\mathfrak{12};\ss'}^{\k}=\Sigma_{\text{HF};\mathfrak{12}}^{\vv{k}}-\sum_{\substack{\q;\mathfrak{abcd}\\\mathfrak{efgh};\sigma_1}}\mathcal{U}^{\vv{q}}_{\mathfrak{a1bc}}\left [\gamma_{\mathfrak{aced};\ss'}^{\q\k}\big (\unity_{\mathfrak{deh2}}^{\k\kp}-\mathcal{U}^{\vv{q}}_{\mathfrak{defg};\ss_1}\chi_{\mathfrak{gfh2};\sigma_1\sigma'}^{\q}\big)\right ]G_{\mathfrak{bh}}^{\k-\q}.
\end{align}
...
\begin{figure}[ht!]
	\centering
  	...
  	\label{fig:sde_vrg}
\end{figure}
This expression has some numerical advantages, as the frequency dimensions of the Fermi-Bose vertices needed for the calculation of the self-energy are by one smaller compared to the approach with the full vertices, hence reducing memory capacity in the process. 
\\\\
...
\begin{align}
	\chi_{\mathfrak{1234};\ss'}^{*;X;\q\k\kp}=\chi_{\mathfrak{1234};\ss'}^{X;\q\k\kp}+\!\! \sum_{\substack{\k_1\k_2;\mathfrak{abcd}\\\sigma_1\sigma_2}}\!\! \frac{\chi_{\mathfrak{12ba};\ss_1}^{X;\q\k\k_1} \mathcal{U}^{X;\vv{qk}_1\vv{k}_2}_{\mathfrak{abcd};\sigma_1\sigma_2} \chi_{\mathfrak{dc34};\sigma_2\sigma'}^{X;\q\k_2\kp}}{\unity - \mathcal{U}^{X;\vv{qk}_1\vv{k}_2}_{\mathfrak{12ab};\ss_1}\chi^{X;\q\k_2\k_1}_{\mathfrak{ba34};\sigma_1\sigma'}}.
\end{align}
...
\end{align}
\end{subequations}
where $\bm\unity$ is an identity matrix in grouped index space. After some algebra, the full vertex in the density and magnetic spin combinations reads1
\begin{subequations}
\begin{align}
\begin{split}
...
\begin{align}
	\Sigma^{\k}_{\dga;\mathfrak{12}}&=\Sigma_{\text{H};\mathfrak{12}}^{\vv{k}}-\sum_{\substack{\q;\mathfrak{abcd}\\\mathfrak{efgh}}}\Bigg [\bigg (\mathcal{U}^{\vv{q}}_{\mathfrak{a1bc}} -\frac12 \tilde{\mathcal{U}}_{\mathfrak{a1bc}} \bigg )\,\gamma_{\dens;\mathfrak{cbed}}^{\q\nu}\!\left (\unity_{\mathfrak{de2h}}-\mathcal{U}^{\vv{q}}_{\dens;\mathfrak{defg}}\chi^{\q}_{\dens;\mathfrak{gf2h}}\right )\nonumber\\
	&\qquad\qquad\qquad\qquad\qquad-\frac32 \tilde{\mathcal{U}}_{\mathfrak{a1bc}}\gamma_{\magn;\mathfrak{cbed}}^{\q\nu}\!\left (\unity_{\mathfrak{de2h}}-\mathcal{U}^{\vv{q}}_{\magn;\mathfrak{defg}}\chi^{\q}_{\magn;\mathfrak{gf2h}}\right )\!\!\Bigg]G_{\mathfrak{ah}}^{\k-\q} - \Sigma^{\k}_{\text{dc};\mathfrak{12}}\nonumber\\
\begin{split}
	&=\Sigma_{\text{H};\mathfrak{12}}^{\vv{k}}-\sum_{\substack{\q;\mathfrak{abcd}\\\mathfrak{efgh}}}\Bigg [\bigg (U_{\mathfrak{a1bc}} + V^{\vv{q}}_{\mathfrak{a1bc}} -\frac12 U_{\mathfrak{acb1}} \bigg )\,\gamma_{\dens;\mathfrak{cbed}}^{\q\nu}\times\\
	&\qquad\qquad\qquad\qquad\qquad\times\Big (\unity_{\mathfrak{de2h}}-\left (2U_{\mathfrak{defg}}+2V^{\vv{q}}_{\mathfrak{defg}}-U_{\mathfrak{dgfe}}\right )\chi^{\q}_{\dens;\mathfrak{gf2h}}\Big )\\
	&\qquad\qquad\qquad\qquad\qquad-\frac32 U_{\mathfrak{acb1}}\gamma_{\magn;\mathfrak{cbed}}^{\q\nu}\!\left (\unity_{\mathfrak{de2h}}+U_{\mathfrak{dgfe}}\chi^{\q}_{\magn;\mathfrak{gf2h}}\right )\!\!\Bigg]G_{\mathfrak{ah}}^{\k-\q} - \Sigma^{\k}_{\text{dc};\mathfrak{12}},
\end{split}
\end{align}
where $\Sigma_{\text{H};\mathfrak{12}}^{\vv{k}}$ only denotes the Hartree-contribution, since the Fock term cancels in the process of rewriting the SDE with \eqref{eq:vrg}.
