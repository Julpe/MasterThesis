...
\subsection{Kernel-function approach}\label{sec:vertex_asymptotics_kernel}
...
\subsection{U-range and RPA-esque approach}\label{sec:vertex_asymptotics_urange}

TODO, and read through
...
For an alternative formulation using the three-leg vertices already derived in \secref{sec:schwinger_dyson}, see \eqref{eq:vrg}, we have to rewrite \eqref{eq:sde_with_phbar} with the full ladder vertices $F^{\q\nu\nu'}_{\dens/\magn;\mathfrak{1234}}$,
\begin{align}
...
\begin{align}
	\Sigma^{\k}_{\dga;\mathfrak{12}}&=\Sigma_{\text{HF};\mathfrak{12}}^{\vv{k}}-\sum_{\substack{\q;\mathfrak{abcd}\\\mathfrak{efgh}}}\Bigg [\!\bigg (\mathcal{U}^{\vv{q}}_{\mathfrak{a1bc}} -\frac12 \tilde{\mathcal{U}}_{\mathfrak{a1bc}} \bigg )\,\gamma_{\dens;\mathfrak{cbed}}^{\q\nu}\!\left (\unity_{\mathfrak{de2h}}-\mathcal{U}^{\vv{q}}_{\dens;\mathfrak{defg}}\chi^{\q}_{\dens;\mathfrak{gf2h}}\right )\nonumber\\
...
\begin{split}
	&=\Sigma_{\text{HF};\mathfrak{12}}^{\vv{k}}-\sum_{\substack{\q;\mathfrak{abcd}\\\mathfrak{efgh}}}\Bigg [\!\bigg (U_{\mathfrak{a1bc}} + V^{\vv{q}}_{\mathfrak{a1bc}} -\frac12 U_{\mathfrak{acb1}} \bigg )\,\gamma_{\dens;\mathfrak{cbed}}^{\q\nu}\times\\
