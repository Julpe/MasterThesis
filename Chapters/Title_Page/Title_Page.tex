\begin{titlepage}
    ...
    Betreuer: Univ.-Ass.\ \textbf{Viktor Christiansson}, PhD\\
    Betreuer: Projektass.(FWF) \textbf{Eric Jacob}, MSc

    \vspace{5em}

    \noindent Wien, \germandateformat\today\hspace{2.5cm}\rule{4.5cm}{0.25pt}\hspace{1cm}\rule{4.5cm}{0.25pt}

	\phantom{\noindent Wien, \germandateformat\today}\hspace{2.5cm}Julian Peil\hspace{3.8cm}Karsten Held
\end{titlepage}
