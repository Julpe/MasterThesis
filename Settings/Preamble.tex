...
%\renewbibmacro*{journal}{\printfield{shortjournal}} % shortjournal field instead of full name
...
\newdateformat{germandateformat}{\THEDAY{. }\monthnamengerman[\THEMONTH], \THEYEAR}
\newdateformat{englishdateformat}{\monthname[\THEMONTH] \nth{\THEDAY}, \THEYEAR}